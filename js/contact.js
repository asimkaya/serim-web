...
function SetContactLanguage() {
  ...
  if (lang == "en") {
    $("#name").attr("placeholder", "Name Surname");
    $("#phone").attr("placeholder", "Phone Number");
    $("#about").attr("placeholder", "Subject");
    $("#message").attr("placeholder", "Message");
  } else {
    $("#name").attr("placeholder", "Ad Soyad");
    $("#phone").attr("placeholder", "Tel No.");
    $("#about").attr("placeholder", "Konu");
