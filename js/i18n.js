$(document).ready(function () {
  const arrLang = {
    tr: {
      ...
      "nav-3": "Hakkımızda",
      "nav-4": "İletişim",
      "mob-nav-1": "Abfgo Biletleme Sistemi",
      "mob-nav-2": "ParkoMobil Akıllı Otopark Yönetimi",
      "mob-nav-3": "Hey Mobility Araç Paylaşım Platformu",
    ...
    en: {
      ...
      "nav-3": "About Us",
      "nav-4": "Contact",
      "mob-nav-1": "Abfgo Ticketing System",
      "mob-nav-2": "ParkoMobil Smart Parking Management",
      "mob-nav-3": "Hey Mobility Sharing Platform",
