$(document).ready(function () {
  const arrLang = {
    tr: {
      ...
      "carousel-4": "ParkoMobil yenilikçi mobil teknoloji, görüntü işleme ve e-arşiv fatura ile otopark yönetimini kolaylaştırır...",
      "carousel-5": "Paylaşım Platformu",
      "carousel-6": "HEY Mobilite araç paylaşım ve yönetim platformu için esnek, ölçeklenebilir ve etkin bir çözümdür...",
    },
    ...
    en: {
      ...
      "carousel-4": "ParkoMobil facilitates parking lot management with innovative mobile technology, image processing and e-archive invoice...",
      "carousel-5": "Sharing Platform",
      "carousel-6": "HEY Mobility is a flexible, scalable and efficient solution for vehicle sharing and management platform...",
    },
  };
